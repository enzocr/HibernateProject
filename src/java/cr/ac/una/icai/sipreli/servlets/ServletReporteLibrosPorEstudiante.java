 ...
 */
public class ServletReporteLibrosPorEstudiante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Integer carnet = (Integer) sessionMap.get("carnetAEnviarAlServlet");  //****  SE OBTIENEN LOS VALORES QUE VIENEN DEL BEAN  ******//

            //HASHMAP PARA LOS PARAMETROS DEL REPORTE
            parametrosReporte.put("carnet", carnet); //***  SE PASA EL PARAMETRO AL REPORTE-> EL 1 ES EL NOMBRE DEL PAREMETRO EN EL REPORTE, EL 2 ES EL VALOR QUE VA   *******//
            ...
            nombreJasper = "reporteLibrosPorEstudiante.jasper";               //******  SE ESPECIFICA EL NOMBRE DEL JASPER A UTILIZAR ******************//
            nombreArchivo = "Reporte_Libros_Por_Estudiantes.xls";         //******  SE ESPECIFICA EL NOMBRE DEL REPORTE A GENERAR ******************//
